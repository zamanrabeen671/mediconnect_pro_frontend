...
export default function AdminDoctors() {
  ...
  const statusConfig = {
    ...
    pending: { icon: FaClock, color: "text-yellow-500", bg: "bg-yellow-50", label: "Pending" },
              ...
              <table className="w-full">
                <thead className="bg-muted">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-semibold text-foreground">Institute</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-foreground">BMDC Number</th>
