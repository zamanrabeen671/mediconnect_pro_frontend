...
import { brandDelete, getBrandList } from "../../store/API/brandApi";
...
const BrandList = () => {
  ...
  const handleDeleteProduct = (brandId: number) => {
    Swal.fire({
      title: "Are you sure?",
  ...
  return (
    <div className="flex flex-col gap-4 px-4 pt-6 text-start text-black dark:text-white h-screen">
      ...
      <div className="mt-8 flex justify-end">
        <Pagination
          pageCount={brandList?.total && Math.ceil(brandList?.total / limit)}
